                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-8 m-auto">
                            ...
                            <p className="lead text-center">Create Your Dev Space Account</p>
                            ...
                            <form noValidate onSubmit={this.onSubmit}>
                                ...
                                <TextFieldGroup placeholder="Email Address" name="email" type="email" value={this.state.email} onChange={this.onChange} error={errors.email} info="This Site Uses " />
